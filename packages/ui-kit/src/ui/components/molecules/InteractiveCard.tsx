...
export const InteractiveCard: React.FC<InteractiveCardProps> = ({
        ...
        {image ? (
          ...
          <View style={styles.containerWithImage}>
            ...
            <View style={styles.imageWrapper}>
              {imageType === "avatar" ? (
                ...
                <Logo source={image} width={imageSize} height={imageSize} resizeMode="contain" />
              )}
            </View>
          ...
          <>
            <View style={subtitle && onFavoriteToggle ? styles.rowWithFavorite : undefined}>
              ...
              {/* Favorite Toggle */}
              {onFavoriteToggle && (
                <TouchableOpacity style={styles.favoriteIcon} onPress={handleFavoritePress} activeOpacity={0.7}>
                  <Icon
  ...
  return onCardPress || onPressIn ? (
    <TouchableOpacity onPressIn={onPressIn} onPress={onCardPress} activeOpacity={0.8} style={style}>
